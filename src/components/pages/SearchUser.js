            ...
            <div className='flex flex-col h-[calc(100vh_-_242px)] w-full justify-center items-center' >
                <div className='w-full max-w-[280px] md:max-w-[400px] 2xl:max-w-[660px] relative'>
                    <TextField
                        ...
                        inputstyle="bg-[#101010] focus-visible:outline-none placeholder:text-[#A6A6A6] hidden md:block w-full lg:text-[16px] 2xl:text-5 leading-5 text-[#A6A6A6] rounded-[10px] 2xl:rounded-[15px] py-2 xl:py-3 4xl:text-[20px] 4xl:py-4 px-6"
                    />
