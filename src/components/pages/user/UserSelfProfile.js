      ...
      <div className="pb-10">
        <div className="md:pt-[18px] 2xl:pt-[30px] rounded-b-[20px] overflow-hidden relative">
          <div className="absolute pt-4 pl-4 md:pt-6 2xl:pt-14 xl:pl-[42px] ">
            {isLoading ?
              <DataLoader lines={1}  lineClassName="bg-gray-500 relative w-screen h-screen max-w-[84.72px] md:max-w-[86px] max-h-[98.39px] lg:max-w-[125px] xl:max-w-[140px] lg:max-h-[140px] xl:max-h-[170px] 2xl:max-w-[217px] 2xl:max-h-[252px]" />
            :
          ...
          <div className=" bg-[#040404] pl-[126px] lg:pl-[180px] xl:pl-[220px] 2xl:pl-[328px] pr-[24.42px] rounded-t-[20px] pt-[23px] 2xl:pt-[61px]">
            ...
            <div className="flex flex-col gap-3">
              ...
              <DataLoader
                lines={1}
                lineClassName="h-[20px] md:h-[16px] lg:h-[24px] 2xl:h-[32px] bg-gray-500"
                containerClassName="max-w-[200px] flex-col gap-2"
              />
            </div>
            :
