...
const AdminHeader = ({ type, title, showControls = true }) => {
  ...
  return (
    <div className="pb-3 md:pt-[36px] 2xl:pt-[72px] flex lg:gap-14 justify-between md:items-start lg:items-center w-full items-center md:flex-col lg:flex-row">
      <p className="text-white whitespace-pre-wrap 2xl:whitespace-nowrap 2xl:leading-[42px] leading-5 text-xl max-w-[65%] md:max-w-none   md:text-[28px] lg:text-[30px] xl:text-[34px] 4xl:text-[34px]">
      ...
      {showControls && (
        <div className="gap-[10px] md:gap-6 items-center flex">
          <TextField
            iconAfter={
              <SearchIcon className="h-[14px] 2xl:h-[17px] hidden  w-[14px] 2xl:w-[17px]" />
            }
            type="text"
            name="searchTerm"
            value={searchTerm}
            ...
            placeholder="Search"
            inputstyle="md:hidden bg-[#101010] focus-visible:outline-none placeholder:text-[#A6A6A6] hidden md:block md:max-w-[200px] 2xl:max-w-[250px] 4xl:max-w-[300px] w-screen lg:text-[16px] 2xl:text-5 leading-5 text-[#A6A6A6] rounded-[10px] 2xl:rounded-[15px] py-2 xl:py-3 4xl:py-4 px-6"
          />
          <CustomButton
            type="submit"
            ...
            buttonStyle="hidden  lg:leading-[16px] 2xl:leading-6 4xl:w-screen w-full 4xl:max-w-[200px] px-3 2xl:px-6 4xl:px-0 py-[6px] lg:py-2 xl:py-3 lg:text-sm h-max 4xl:h-[51px] text-[12px] 2xl:text-sm  border border-[#DD69AA] font-medium rounded-[12px] 2xl:rounded-2xl text-[#DD69AA]"
          >
            Remove
          </CustomButton>
          <CustomButton
            ...
            buttonStyle="hidden lg:leading-[16px] 2xl:leading-6 4xl:w-screen w-full 4xl:max-w-[200px] px-3 2xl:px-6 4xl:px-0 py-[6px] lg:py-2 xl:py-3 lg:text-sm h-max 4xl:h-[51px] text-[12px] 2xl:text-sm border border-[#DD69AA] font-medium rounded-[12px] 2xl:rounded-2xl text-[#DD69AA] whitespace-nowrap"
          >
            Award Point
          </CustomButton>
          <CustomButton
            onClick={() => dispatch(openModal({ type }))}
            buttonStyle="hidden lg:leading-[16px] 2xl:leading-6 4xl:w-screen w-full 4xl:max-w-[200px] px-3 2xl:px-6 4xl:px-0 py-[6px] lg:py-2 xl:py-3 lg:text-sm h-max 4xl:h-[51px] text-[12px] 2xl:text-sm font-medium rounded-[12px] 2xl:rounded-2xl text-white bg-[#DD69AA] whitespace-nowrap"
          >
            {type === "business" ? "Add Business" : "Add Customer"}
          </CustomButton>
          <button className="block md:hidden p-[3px] relative group"
            onClick={() => dispatch(openModal({ type: type === "user-profile" ? "message" : type }))}
          >
