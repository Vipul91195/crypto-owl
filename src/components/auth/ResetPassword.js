                ...
                >
                    ...
                    (<form onSubmit={handleSubmit} >
                        <div className='max-w-[410px]'>
                            ...
                            <div className='text-base pt-5 lg:pt-6 pb-1 lg:text-sm font-medium tracking-tight text-pink-light 2xl:pb-3'>
                            ...
                            <CustomButton
                                ...
                                buttonStyle="lg:w-[350px] mt-7 2xl:w-[410px] w-full py-[14px] 2xl:py-5 text-base sm:text-sm font-bold rounded-2xl text-pink-light bg-[#DD69AA]">
                                Submit
                            </CustomButton >
                        </div>
                    </form>)}
