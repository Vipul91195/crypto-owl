            ...
            >
                ...
                (<form onSubmit={handleSubmit} >
                    ...
                    <div className='flex justify-between gap-[60px] xl:gap-[77px] items-center pt-[16px] md:pt-[18px] pb-[22px] md:pb-[24px] xl:pt-[30px] xl:pb-[36px]'>
                        ...
                        <Dropdown
                            inputstyle='w-[163px] xl:w-[304px] text-white text-base leading-[10px] xl:text-2xl outline-none h-[25px] py-[12px] flex items-center xl:h-[48px] rounded-[5px] xl:rounded-2xl bg-[#303030] xl:bg-[#101010] pl-2 lg:pl-5'
                            options={options}
