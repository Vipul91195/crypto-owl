...
const AwardPoint = ({ type, memberId, onSubmit }) => {
    ...
    return (
        <div className='max-w-[600px] bg-[#101010] xl:bg-[#1C1C1C] py-[22px] px-[18px] xl:p-6 2xl:px-9 2xl:py-9'>
            <Formik
                ...
                (<form onSubmit={handleSubmit} >
                    ...
                    <div className='flex justify-end'>
                        <CustomButton
                            ...
                            loaderSize={20}
                            type='submit'
                            buttonStyle="w-full py-[7.5px] xl:py-3 text-[#DD69AA] xl:text-white text-xl font-medium rounded-[10px] xl:text-[24px] 2xl:text-3xl xl:font-bold xl:rounded-2xl xl:bg-[#DD69AA] border-[1.5px] border-[#DD69AA] xl:border-none">
                            Award Point
                        </CustomButton >
                    </div>
                </form>)}
