...
const CustomerForm = () => {
    ...
    const { isLoading, businessCustomers} = useSelector(state => ({
    ...
    const handleLoginSubmit = (values) => {
        console.log(values, " customer submit ");
        dispatch(addCustomer({business_id: 1, customer: values}));
    }
            ...
            <form onSubmit={handleSubmit}>
              <div className=" pt-7 pb-11 bg-black px-[31.5px]">
                <div className="flex text-left flex-col gap-[14px]">
                  <div>
                    <div className="text-sm font-medium tracking-tight text-pink-light pb-[13px]">
                  ...
                  <div className="flex gap-10 mt-[34px]">
                    ...
                    {/* <a
                      className="w-full h-[44.83px] flex items-center justify-center text-sm leading-6 tracking-tight font-medium  text-[#DD69AA] border border-[#DD69AA] rounded-2xl"
                       href={`${process.env.REACT_APP_PUBLIC_baseURL}admin/template/`}
                    > */}
                      <CustomButton
