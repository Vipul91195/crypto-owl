...
import { sendMessage } from '../Redux/commonSlice';
                ...
                (<form onSubmit={handleSubmit} >
                    <div className='pt-4 xl:pt-5 2xl:pt-[26px] pb-6 bg-[#1C1C1C] px-[19px] xl:px-[25px] 2xl:px-[29px] '>
                        <div className='flex text-left flex-col gap-[14px] xl:gap-[30px] 2xl:gap-[35px]'>
                            <div>
                                <label className='text-[18px] xl:text-[28px] 2xl:text-[32px] font-medium tracking-tight text-pink-light pb-2 xl:pb-[20px] block'>Subject<span className='text-[#DD69AA]'>*</span></label>
                                {/* 
                              ...
                              py-[8px] xl:py-[10px] rounded-[10px] 2xl:rounded-2xl border border-[#FFFFFF]/[10%] bg-transparent  xl:pl-[25px] pl-[15.56px]'
                                    borderstyle='w-full text-[#858383] text-sm xl:text-xl font-normal tracking-[-0.02em] outline-none
                                    py-[8px] xl:py-[10px] rounded-[10px] 2xl:rounded-2xl border border-red-800 bg-transparent  xl:pl-[25px] pl-[15.56px]'
                                    errorRight={true}
                                    type='text'
                                    id='subject'
                                    name='subject'
